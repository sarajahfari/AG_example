...
1. Getting started
----------------------
Ancestral Graphs relies on a number of packages such as graphs, RBGL and ggm. These packages are updated in a fast rate, and for now you will have to run an older version of R (version 3.0.2) in order to use the validated versions of these packages for AG. You can find the checked packages versions in the folder AG_codes/Rpackage_checked. 
