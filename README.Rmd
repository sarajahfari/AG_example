...
Before running throught the example bellow get an intution for the method and stats reading Lourens Waldorp's 2011 NI paper [here](http://www.sciencedirect.com/science/article/pii/S1053811910013479).

1. Getting started
----------------------
Ancestral Graphs relies on a number of packages such as graphs, RBGL and ggm. These packages are updated in a fast rate, and for now you will have to run an older version of R (version 3.0.2) in order to use the validated versions of these packages for AG. You can find this version in the folder AG_codes/Rpackage_checked. 
...
For a workflow please read the AG_Readme.pdf. All of these steps are also in the *EvaluateStop_example.R*. If you have questions let me know. Have fun!
